...
//
	...
	function processor(xhr) {
	        ...
	        if (uData.url) {
					    ...
					    setTimeout(	function() {
										/*if (window.opera)
										{*/
											GM_xmlhttpRequest_Opera({'method':'GET', 'url':uData.url,'onload':processor, 'onerror':processor});
										/*} else	
										{
	...
	function hoverInfo() 
	{
		...
		div_obj.style.background = "#fff url(http://pit.dirty.ru/lepro/2/2010/03/09/13055-180217-97f8df2bba35267fdfb7a0a0d7f005e7.gif) center center no-repeat";
